...
const Profile = () => {
  ...
  const handleNavigate = () => {
    if (userInfo.profileSetup && firstName && lastName) {
      navigate("/chat");
    } else {
      ...
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            {hovered && (
              <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 ring-fuchsia-50 rounded-full cursor-pointer">
                {image ? (
